...
#da linha 3 à 5 pede para a pessoa digitar as três notas e guarda o resultado em variáveis, depois o código verifica se as notas são iguais ou se tem uma maior que as outras, e imprime a mensagem. Se as três notas forem iguais, imprime "Todas as notas são iguais". Se duas notas forem iguais e maiores que a terceira, imprime "As duas maiores notas são iguais". Se uma nota for maior que as outras, imprime qual é a maior nota.
...
#a linha 3 e 4 pede para a pessoa digitar o saldo da conta e o valor do saque, depois o código verifica se o valor do saque é maior que zero, se for, diminui o valor do saque do saldo da conta, e depois verifica se o saldo resultante é positivo, negativo ou zero, e imprime a mensagem correspondente. Se o valor do saque for menor ou igual a zero, imprime uma mensagem de erro.  
...
#questão até que é dboa a linhas 59 até a 72 fala sobre o resultado da pontuação dos jogadores, verificando se um jogador tem a maior pontuação, ou se tem dois jogadores empatados com a maior pontuação, ou se os três jogadores empataram. E imprime a mensagem correspondente.
...
#achei melhor do jeito que eu queria mas desse jeito não é tão ruima de fazer também
